...
class CoreDataStack {
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataStack.self).url(forResource: "RadiusAssignment", withExtension: "momd")! // type your database name here..
    ...
    static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = applicationDocumentsDirectory.appendingPathComponent("RadiusAssignment.sqlite") // type your database name here...
        print("Sqlite path = \(url)")
